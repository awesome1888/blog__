  ...
  <List>
    <Row>
      <Container lg="4" sm="12">
        <Skill label="JavaScript" logo={javaScriptLogo} level="10" iRound={true} />
      </Container>
      <Container lg="4" sm="12">
      ...
      <Container lg="4" sm="12">
        <Skill label="NodeJS" logo={nodeJsLogo} level="8" iOffs="1.5rem" iHeight="61%" />
      </Container>
      <Container lg="4" sm="12">
        <Skill label="LESS" logo={lessLogo} level="5" iOffs="1.7rem" iHeight="44%" />
      </Container>
      <Container lg="4" sm="12">
      ...
      <Container lg="4" sm="12">
        <Skill label="Saga" logo={sagaLogo} level="3" iOffs="1.0rem" iHeight="61%" />
      </Container>
      <Container lg="4" sm="12">
      ...
      <Container lg="4" sm="12">
        <Skill label="Linux" logo={linuxLogo} level="9" iOffsH="0.5rem" />
      </Container>
      <Container lg="4" sm="12">
        <Skill label="StyledComponents" logo={styledComponentsLogo} level="4" techNameSize="0.9rem" />
      </Container>
    </Row>
  </List>
);
